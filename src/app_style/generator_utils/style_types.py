...
from app_style.qt.util.pixel_val import PixelVal
from app_style.qt.util.s_color import SColor
...
class QSSTheme:
    ...
    win_close = SColor(120) if PlatformService.IsWindows else SColor(237, 107, 95)
    win_minimize = SColor(120) if PlatformService.IsWindows else SColor(245, 191, 79)
    win_maximize = SColor(120) if PlatformService.IsWindows else SColor(98, 197, 84)
